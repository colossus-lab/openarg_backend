    ...
    def _to_data_result(self, title: str, records: list[dict]) -> DataResult:
        ...
        for r in records:
            ...
            formatted.append({
                ...
                "nombre": r.get("nombre", ""),
                "sexo": r.get("sexo", ""),
                "fecha nacimiento": r.get("fechaNacimiento", ""),
                "estado civil": r.get("estadoCivil", ""),
                "cargo": r.get("cargo", ""),
                "organismo": r.get("organismo", ""),
                "año declaracion": r.get("anioDeclaracion", ""),
                "tipo declaracion": r.get("tipoDeclaracion", ""),
                "bienes inicio": r.get("bienesInicio", 0),
                "deudas inicio": r.get("deudasInicio", 0),
                "bienes cierre": r.get("bienesCierre", 0),
                "deudas cierre": r.get("deudasCierre", 0),
                "patrimonio cierre": r.get("patrimonioCierre", 0),
                "variacion patrimonial": r.get("bienesCierre", 0) - r.get("bienesInicio", 0),
                "ingresos trabajo neto": r.get("ingresosTrabajoNeto", 0),
                "gastos personales": r.get("gastosPersonales", 0),
                "cantidad bienes": len(bienes),
                "bienes detalle": bienes,
                "resumen bienes": _summarize_assets(bienes),
            })
